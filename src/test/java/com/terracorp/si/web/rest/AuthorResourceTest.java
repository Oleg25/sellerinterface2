...
import com.terracorp.si.repository.AuthorRepository;
import com.terracorp.si.repository.search.AuthorSearchRepository;
...
public class AuthorResourceTest {
    ...
    private static final LocalDate DEFAULT_BOD = new LocalDate(0L);
    private static final LocalDate UPDATED_BOD = new LocalDate();
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBod()).isEqualTo(DEFAULT_BOD);
    }
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors"))
                ...
                .andExpect(jsonPath("$.[*].bod").value(hasItem(DEFAULT_BOD.toString())));
    }
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.bod").value(DEFAULT_BOD.toString()));
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBod()).isEqualTo(UPDATED_BOD);
    }
